...
using AutoBazaar.Common.Web.Filters;
using AutoBazaar.Common.Web.Services;
using AutoBazaar.Common.Web.TenantResolutionStrategies;
using Autofac;
...
namespace AutoBazaar.Common.Web.Extensions
{
    public static class WebApplicationBuilderExtensions
    {
        public static WebApplicationBuilder AddAutoBazaarWebApplication(
            this WebApplicationBuilder builder, string appName, Action<IServiceCollection> configure, List<JsonConverter> converters = null)
        {
            ...
            {
                configure.Title = $"AutoBazaar {appName} API";
        ...
        public static MultitenantContainer ConfigureMultitenantContainer(Autofac.IContainer container)
        {
