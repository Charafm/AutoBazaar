using AutoBazaar.Common.Application.Exceptions;
...
namespace AutoBazaar.Common.Web.Filters
{
    public class ApiExceptionFilter : ExceptionFilterAttribute
    {
        ...
        public ApiExceptionFilter(ILogger<ApiExceptionFilter> logger, IStringLocalizer<Messages> localizer, IHostingEnvironment hostingEnvironment, IOptions<ErrorDetailsOptions> options)
        {
            ...
            _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext>>
            {
                ...
                {typeof(AutoBazaar.Common.Application.Exceptions.ApplicationException), HandleApplicationExceptionException}
            };
            _logger = logger;
        ...
        {
            var exception = context.Exception as Application.Exceptions.ApplicationException;
